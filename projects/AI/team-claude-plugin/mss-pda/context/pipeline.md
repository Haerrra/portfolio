...
## Local Environment
- 로컬 레포 경로: $MSS_LOCAL_REPO
- DAG 파일 경로: $MSS_LOCAL_REPO/$MSS_DAG_DIR/
- SQL 파일 경로: $MSS_LOCAL_REPO/$MSS_SQL_DIR/
- 원격 레포: https://github.com/musinsa/airflow-data-analysis
- Airflow 동기화 경로: $MSS_LOCAL_REPO/$MSS_DAG_DIR/ (dags/pxa/ 하위만 동기화됨)

## File Placement Rules
- DAG (.py) 파일: $MSS_LOCAL_REPO/$MSS_DAG_DIR/pxa_pipeline_{ticket_id}.py
- SQL 파일: $MSS_LOCAL_REPO/$MSS_SQL_DIR/pxa_pipeline_sql_{ticket_id}.sql
...
- 작업 프로세스
  ...
  - PR 대상: https://github.com/musinsa/airflow-data-analysis
