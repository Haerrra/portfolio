-- CREATE OR REPLACE TABLE `team`.`tech`.customers_alert_agree_dashboard_success5 AS (
INSERT INTO `team`.`tech`.customers_alert_agree_dashboard_success5

-- (앱버전별/최초지면별) 지면별 기기 알림 바텀시트/넛지 노출 유저 수
-- (앱버전별/최초지면별) 지면별 기기 알림 바텀시트/넛지 노출 수
-- (앱버전별/최초지면별) 지면별 기기 알림 바텀시트/넛지 클릭 유저 수
-- (앱버전별/최초지면별) 지면별 기기 알림 바텀시트/넛지 클릭 수
-- (앱버전별/최초지면별) 기기 알림 클릭 전환율
-- (앱버전별/최초지면별) 기기 알림 클릭 빈도
-- (앱버전별/최초지면별) 마광수동 동의 클릭 전환율
-- (앱버전별/최초지면별) 마광수동 동의 클릭 빈도
SELECT
    date
    , app_version_group
    , first_page_group
