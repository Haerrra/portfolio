-- mss-pda 텔레메트리 적재 대상 테이블 스키마 정의 (Reference Only)
--
-- ⚠️ 이 파일은 *실행용*이 아니라 *참고용*입니다.
--   - 운영 테이블 `team.tech.pxa_ai_invocations_raw` / `team.tech.pxa_ai_feedback_raw`는
--     이미 MSS PDA팀에서 생성·운영 중. 일반 사용자는 이 파일을 실행할 필요 없음.
...
-- 스키마 변경 정책: telemetry/schema.md + measurement.md 참조 (owner: haera.kang)

-- ============================================================================
-- 1) Invocations: hooks가 발화하는 모든 raw event 적재
-- ============================================================================
CREATE TABLE IF NOT EXISTS team.tech.pxa_ai_invocations_raw (
...
-- ============================================================================
-- 2) Feedback: /mss-pda:feedback 호출 1건 = 1 row
-- ============================================================================
CREATE TABLE IF NOT EXISTS team.tech.pxa_ai_feedback_raw (
...
-- ============================================================================
ALTER TABLE team.tech.pxa_ai_feedback_raw
